...
public class Util
{
    ...
    public static final String FOOD_LATITUDE = "lat";
    public static final String FOOD_LONGITUDE = "lon";
    ...
    public static final String CREATE_FOOD_TABLE = "CREATE TABLE " + FOOD_TABLE_NAME + "(" + FOOD_ID
            ...
            FOOD_PICKUP_TIMES + " TEXT," + FOOD_QUANTITY + " INTEGER," + FOOD_LOCATION + " TEXT,"
            + FOOD_LATITUDE + " REAL, "
            + FOOD_LONGITUDE + " REAL"
            + ")";
